...
\section{Architectural Views}
    ...
    \begin{itemize}
        \item AmazonGo is a system that needs to handle several different tasks at the same time. Some of these tasks follow similar routines,
        therefore some generic components and interfaces like Sensor Communucation system are used, which allows to keep the diagram simple
        and more understandable.
        \item Remote Server subsystem is the subsystem that
    \end{itemize}
