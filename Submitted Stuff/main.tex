...
\section{Architectural Views}
    ...
    \begin{center}
        \begin{figure}[H]
            %\includegraphics[width=\linewidth]{Images/WithdrawMoney.png}  %%%%%%%%%%%%%%%HEREEEEEE
    ...
    \begin{center}
        \begin{figure}[H]
           % \includegraphics[width=\linewidth]{Images/QRCodeScan.png}  %%%%%%%%%%%%%%%HEREEEEEE
    ...
    \begin{center}
        \begin{figure}[H]
            %\includegraphics[width=\linewidth]{Images/personalPayment.png}
    ...
    \begin{center}
        \begin{figure}[H]
           % \includegraphics[width=\linewidth]{Images/essd.png}  %%%%%%%%%%%%%%%HEREEEEEE
    ...
    \begin{center}
        \begin{figure}[H]
            %\includegraphics[width=\linewidth]{Images/cvai.png} %%%%%%%%%%%%%%%HEREEEEEE
